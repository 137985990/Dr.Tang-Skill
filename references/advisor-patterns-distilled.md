...
**最后更新：** 2026-05-18
**数据来源：** 40+ 次会议录音转写文本（含 audio1688366793, 录音 (42), 录音 (43), 录音 (44), 录音 (46), 录音 (48)）
...
| P10 | Related work 优先按类别综合，不按论文流水账展开 | 录音 (46)、录音 (48) 都强调：先讲这一类工作在做什么，再用代表论文举例，而不是逐篇罗列；并要讲清共性与代表方法差异 |
| T5 | 缩写、protocol label 和技术短语必须在首次出现时解释清楚 | 录音 (48) 明确点名 `CSDI`、`pooled window-level protocol`、`complete channel setting` 这类词会让读者糊涂 |
